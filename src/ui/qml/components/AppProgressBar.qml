    ...
    contentItem: Item {
        ...
        Rectangle {
            ...
            SequentialAnimation on x {
                ...
                NumberAnimation { from: 0; to: control.width * 0.7; duration: 900; easing.type: Easing.InOutQuad }
                NumberAnimation { from: control.width * 0.7; to: 0; duration: 900; easing.type: Easing.InOutQuad }
            }
        }
    }
}
