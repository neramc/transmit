...
QString settingKeyName(SettingKey key) {
    switch (key) {
        case SettingKey::AppearanceTheme:            return QStringLiteral("appearance.theme");
        case SettingKey::AppearanceAccent:           return QStringLiteral("appearance.accent");
        case SettingKey::DesktopWallpaper:           return QStringLiteral("desktop.wallpaper");
        case SettingKey::LocaleLanguage:             return QStringLiteral("locale.language");
        case SettingKey::LocaleFormats:              return QStringLiteral("locale.formats");
        case SettingKey::LocaleTimezone:             return QStringLiteral("locale.timezone");
        case SettingKey::KeyboardLayouts:            return QStringLiteral("input.keyboard");
        case SettingKey::DefaultBrowser:             return QStringLiteral("defaultApps.browser");
        case SettingKey::DefaultMailClient:          return QStringLiteral("defaultApps.mail");
        case SettingKey::PowerSleepMinutes:          return QStringLiteral("power.sleep");
        case SettingKey::PowerScreenOffMinutes:      return QStringLiteral("power.screenOff");
        case SettingKey::AccessibilityTextScale:     return QStringLiteral("a11y.textScale");
        case SettingKey::AccessibilityHighContrast:  return QStringLiteral("a11y.highContrast");
        case SettingKey::AccessibilityReduceMotion:  return QStringLiteral("a11y.reduceMotion");
        case SettingKey::MouseNaturalScroll:         return QStringLiteral("input.naturalScroll");
        case SettingKey::ClockUses24Hour:            return QStringLiteral("locale.clock24Hour");
        case SettingKey::ShowHiddenFiles:            return QStringLiteral("files.showHidden");
    }
    return {};
}
...
QList<SettingKey> allSettingKeys() {
    return {SettingKey::AppearanceTheme,           SettingKey::AppearanceAccent,
            SettingKey::DesktopWallpaper,          SettingKey::LocaleLanguage,
            SettingKey::LocaleFormats,             SettingKey::LocaleTimezone,
            SettingKey::KeyboardLayouts,           SettingKey::DefaultBrowser,
            SettingKey::DefaultMailClient,         SettingKey::PowerSleepMinutes,
            SettingKey::PowerScreenOffMinutes,     SettingKey::AccessibilityTextScale,
            SettingKey::AccessibilityHighContrast, SettingKey::AccessibilityReduceMotion,
            SettingKey::MouseNaturalScroll,        SettingKey::ClockUses24Hour,
